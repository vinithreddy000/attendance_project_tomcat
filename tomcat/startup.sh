...
sudo tee   /opt/tomcat/webapps/manager/META-INF/context.xml 
<<EOF
...
sudo tee   /opt/tomcat/webapps/host-manager/META-INF/context.xml <<EOF
<?xml version="1.0" encoding="UTF-8"?>
<!--
  Licensed to the Apache Software Foundation (ASF) under one or more
  contributor license agreements.  See the NOTICE file distributed with
...
sudo tee  /opt/tomcat/conf/server.xml <<EOF
<?xml version="1.0" encoding="UTF-8"?>
<!--
  Licensed to the Apache Software Foundation (ASF) under one or more
  contributor license agreements.  See the NOTICE file distributed with
...
<Server port="8105" shutdown="SHUTDOWN">
 ...
 <Connector port="443" protocol="org.apache.coyote.http11.Http11NioProtocol"
        ...
        <SSLHostConfig>
            <Certificate certificateKeyFile="conf/private.pem" certificateFile="conf/domain-crt.crt"
                         type="RSA" />
        </SSLHostConfig>
    </Connector>
...
cd /tmp/git
sudo git init
sudo git clone https://github.com/vinithreddy000/multicloudmonkcert.git
sudo cd multicloudmonkcert

#copy files from. to conf

sudo cp /tmp/git/multicloudmonkcert/domain-crt.crt /tmp/git/multicloudmonkcert/private.pem /opt/tomcat/conf/
# Reload systemd
...
How you are in the tomcat webpage which is under development
EOF
