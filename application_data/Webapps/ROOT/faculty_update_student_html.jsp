...
<%
String roll_no=request.getParameter("input_roll_no");
...
<html>
 ...
 <title>update student</title>
	...
	<body>
            ...
            <form action="faculty_update_student_java.jsp" method="post">
                <table>
                    <tr> <th>Student Name:</th><td><input type="text" name="sname" placeholder="Student Name"  required=""/></td> </tr>
                    <tr> <th>R.No:</th>      <td>  <input type="text" name="rno" value="<%= roll_no%>" required=""></td></tr>
                    ...
                    <tr> <th>Date Of Birth:</th>               <td>  <input type="date" name="dob" placeholder="Date of Birth"  required="" ></td></tr>
                     ...
                     <tr> <th>                   Year : </th>  
                                      <td>    <select name="year" style="width:50%; margin: 1em 0 0;padding: 10px 10px 10px 10px;" required="">
                                        <option>--Select--</option>
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                    ...
                    <tr> <th>                    Semester : </th>  
                                     <td>     <select name="semester" style="width:50%; margin: 1em 0 0;padding: 10px 10px 10px 10px;" required="">
                                        <option>--Select--</option>
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
