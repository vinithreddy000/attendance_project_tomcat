...
<html>
    ...
    <body>
        ...
        <%
             ...
             session.setAttribute("year12", year);
                            String semester=request.getParameter("semester");
                            session.setAttribute("semester12",semester);
        ...
        %>
        Date : <%=toDate%>
        <form method="post" action="faculty_add_attendence_database_java.jsp?date=<%=toDate%>&subject=<%=subject%>&branch=<%=branch%>&semester=<%=semester%>&year=<%=year%>">
         <table  width="auto" >
        <%
                            try{
